		 ...
		 try (Connection conn = DriverManager.getConnection(connectionUrl);
	         ...
	         //   selectSql = "create table EVENTS (GROUPID INT NOT NULL,	EVENTID INT NOT NULL, NAME [NVARCHAR](20) NOT NULL, REFERENCE [NVARCHAR](20) NOT NULL, EVENTDATE [DATETIME]  NOT NULL,  status[NVARCHAR](1) NOT NULL, PRIMARY KEY(GROUPID,EVENTID))";
	          //  statement.execute(selectSql);
	            ...
	            selectSql = "create table PARTICIPANTGROUP (	EVENTID INT NOT NULL, PARTICIPANTGROUPGROUPID INT NOT NULL, PARTICIPANTGROUPNAME [NVARCHAR](20) NOT NULL, REMARKS [NVARCHAR](30) NOT NULL, amount [INT]  NOT NULL,  status[NVARCHAR](1) NOT NULL, PRIMARY KEY(EVENTID,PARTICIPANTGROUPGROUPID))";
	            statement.execute(selectSql);
