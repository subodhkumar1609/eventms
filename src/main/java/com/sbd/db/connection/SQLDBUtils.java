		...
		String connectionUrl =
		 ...
		 try (Connection connection = DriverManager.getConnection(connectionUrl);
	           ...
	           // statement.execute(selectSql);
	            ...
	            selectSql = "create table EVENTS (GROUPID INT NOT NULL,	EVENTID INT NOT NULL, NAME [NVARCHAR](20) NOT NULL, REFERENCE [NVARCHAR](20) NOT NULL, EVENTDATE [DATETIME](1)  NOT NULL,  status[NVARCHAR](1) NOT NULL, PRIMARY KEY(GROUPID,EVENTID))";
	            statement.execute(selectSql);
	            ...
	            selectSql = "CREATE TABLE EXPENCES (EXPENSEID INT NOT NULL, EVENTID INT NOT NULL,USERID [NVARCHAR](20) NOT NULL, EXPENSEGROUPID [INT] NOT NULL, DETAILS [NVARCHAR](50), amount [INT](1)  NOT NULL, EXPENCETYPE [NVARCHAR](20), SETTLEMENTFLAG [NVARCHAR](1), REMARKS [NVARCHAR](30) NOT NULL , PRIMARY KEY(EXPENSEID))";
	            statement.execute(selectSql);
